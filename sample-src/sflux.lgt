...
:- category(sflux).
	...
	:- public(execute/3).
	:- info(execute/3, [
		comment is 'Relates the execution of an action to its initial and resulting state, and performs the action',
		arguments is [
	...
	%% category.
	%% If you wish to use this predicate you must provide your own definition 
