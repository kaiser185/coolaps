...
COOLAPS daemon runner sample

This file sets appropriate prolog settings and initializes the  http_daemon after
all dependencies have been loaded.

This is the main entrypoint of the application and is run by the docker container
by default.
